...
credentials = {"form_name": "Login", "usernames": {"user": {"name": "user", "password": "$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW"}}}  # Hashed "test" password
cookie = {"name": "veil_cookie", "key": "random_key", "expiry_days": 1}
authenticator = Authenticate(credentials, cookie['name'], cookie['key'], cookie['expiry_days'])
